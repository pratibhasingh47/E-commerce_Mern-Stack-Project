								...
								<div>
									...
									{isUpdate ?
										(editImage ? <div>
											...
											<FaEdit className='text-xl  cursor-pointer  hover:transform hover:scale-105' onClick={() => { setEditImage(true) }} />
										</div>)
										: <input type="file" className='p-2 py-1 border border-gray-800 outline-none bg-transparent my-3 text-xs' {...register("productImage")} />}
